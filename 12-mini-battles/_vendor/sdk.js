                                ...
                                if(adxAds == true)  {
                                    ...
                                    window.sdk.showBanner();
                                     ...
                                     try {
                                            ...
                                            $.getJSON('https://cdn.jsdelivr.net/gh/playsurd/surd-assets@main/12-mini-battles/', function (data) {
                    ...
                    value: function() {
                        ...
                        this.readyPromise.then(function(t) {
                            ...
                            try {
                                ...
                                $.getJSON("../_hl/dataxx.json", function (data) {
                                    $.each(data, function(i, item) {
                                            urls1 += "|" + item.domain;
                                    });
                                    var url = (window.location != window.parent.location) ? document.referrer : document.location.href;
                            ...
                            try {
                                    ...
                                    $.getJSON("../_hl/datax.json", function (data) {
 ...
 function ShowAds() 
        {
            ...
            try {
                ...
                $.getJSON("../_hl/data.json", function (data) {
