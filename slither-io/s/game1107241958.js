...
var tipss = ["Port by breadbb!", "blocked.invalid!"];
if (lang == "de") tipss = ["Port by breadbb!", "blocked.invalid!"];
else if (lang == "fr") tipss = ["Port by breadbb!", "blocked.invalid!"];
else if (lang == "pt") tipss = ["Port by breadbb!", "blocked.invalid!"];
var tip_pos = -1;
var tip_fr = 1.9;
o.elem.onclick = function () {
    if (!want_play)
