...
function dt(t) {
  return t && M(t.destroy) ? t.destroy : N
}
let y = !1;
...
function I(t) {
  ...
  for (let s = 0; s < e.length; s++) {
    const u = e[s].claim_order,
      a = (r > 0 && e[n[r]].claim_order <= u ? r + 1 : R(1, r, q => e[n[q]].claim_order, u)) - 1;
    i[s] = n[a] + 1;
    const E = a + 1;
    n[E] = s, r = Math.max(E, r)
  }
  const l = [],
    c = [];
  let o = e.length - 1;
...
function pt(t) {
  const e = D("style");
  return e.textContent = "/* empty */", F(z(t), e), e.sheet
}
...
function U(t, e) {
  if (y) {
    for (I(t), (t.actual_end_child === void 0 || t.actual_end_child !== null && t.actual_end_child.parentNode !== t) && (t.actual_end_child = t.firstChild); t.actual_end_child !== null && t.actual_end_child.claim_order === void 0;) t.actual_end_child = t.actual_end_child.nextSibling;
...
function Et(t, e) {
  ...
  for (const i in e) e[i] == null ? t.removeAttribute(i) : i === "style" ? t.style.cssText = e[i] : i === "__value" ? t.value = t[i] = e[i] : n[i] && n[i].set && G.indexOf(i) === -1 ? t[i] = e[i] : S(t, i, e[i])
}
...
function j(t, e, n, i, r = !1) {
  ...
  const l = (() => {
    ...
    for (let c = t.claim_info.last_index - 1; c >= 0; c--) {
      ...
      if (e(o)) {
        const s = n(o);
        return s === void 0 ? t.splice(c, 1) : t[c] = s, r ? s === void 0 && t.claim_info.last_index-- : t.claim_info.last_index = c, o
      }
    }
    return i()
  })();
...
function Bt(t, e) {
  ...
  for (const r of e.childNodes)
    if (r.nodeType === 8) {
      ...
      l === `HEAD_${t}_END` ? (i -= 1, n.push(r)) : l === `HEAD_${t}_START` && (i += 1, n.push(r))
    } else i > 0 && n.push(r);
  return n
}
...
function Y() {
  ...
  do {
    ...
    for (b(null), h.length = 0, f = 0; k.length;) k.pop()();
...
export {
  rt as $, X as A, qt as B, wt as C, Ot as D, Ht as E, vt as F, It as G, Rt as H, Tt as I, k as J, Mt as K, Gt as L, z as M, pt as N, Q as O, $ as P, tt as Q, Y as R, it as S, Kt as T, p as U, b as V, H as W, h as X, V as Y, ht as Z, mt as _, et as a, P as a0, W as a1, Dt as a2, kt as a3, ft as a4, Ut as a5, at as a6, _t as a7, Lt as a8, zt as a9, Ft as aa, Et as ab, Pt as ac, Jt as ad, Wt as ae, nt as af, xt as b, Ct as c, At as d, D as e, K as f, bt as g, St as h, M as i, yt as j, U as k, jt as l, ct as m, N as n, st as o, ut as p, ot as q, B as r, A as s, w as t, lt as u, Nt as v, S as w, dt as x, gt as y, Bt as z
};