! function(t) {
    ...
    var s = e(11),
        ...
        h = {
            adTagUrl: "//blocked.invalid/gampad/ads?sz=640x360|640x480&iu=/1053551/Pub-Poki-Generic&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url={url}&description_url={descriptionUrl}&correlator={timestamp}",
            adTiming: {
                preroll: !1,
                timeBetweenAds: 12e4,
                timePerTry: 7e3,
    ...
    var L = function() {
            ...
            return t.prototype.moveThroughWaterfall = function() {
                ...
                if (this.debug) {
                    var e = "https://blocked.invalid/gampad/ads?sz=640x360|640x480&iu=/21682198607/debug-video/";
                ...
                var o = "https://blocked.invalid/gampad/ads?sz=640x360|640x480&iu=/21682198607/";
    ...
    var rt = e(67),
        ...
        mt = function() {
            ...
            return t.prototype.init = function(t) {
                ...
                var N = S("pokiDebug");
                return N ? (this.setDebug("true" === N), this.debugIsOverwritten = !0) : this.setDebug(this.debug || u), this.debugTouchOverlayController && (v() || b()) && dt(), Promise.all([H(), it(), J("https://imasdk.googleapis.comsa/js/sdkloader/ima3.js"), J("https://removed.invalidsa/tag/js/gpt.js"), Z]).catch((function() {
