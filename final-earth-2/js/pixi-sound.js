 ...
 * Compiled Wed, 31 Jul 2019 14:25:52 UTC
 *
...
! function(t, e) {
  ...
  function i(t, e) {
    try {
      ...
      if (e && ("object" == typeof e || "function" == typeof e)) {
        var o = e.then;
        if (e instanceof n) return t._state = 3, t._value = e, void s(t);
        if ("function" == typeof o) return void a((i = o, u = e, function() {
          i.apply(u, arguments)
        }), t)
      }
  ...
  n.prototype.catch = function(t) {
    ...
    return new n(function(e, n) {
      for (var o = 0, i = t.length; o < i; o++) t[o].then(e, n)
    })
  ...
  var y = function() {
    ...
    g = function(t) {
      function e(e) {
        ...
        return n.id = m++, n._media = null, n._paused = !1, n._muted = !1, n._elapsed = 0, n.init(e), n
      }
      return h(e, t), e.prototype.stop = function() {
        ...
        if (this._source) {
          ...
          y.setParamValue(this._gain.gain, i * o * n), y.setParamValue(this._source.playbackRate, this._speed * e.speed * t.speed)
        }
        ...
        set: function(t) {
          PIXI.ticker.shared.remove(this._updateListener, this), t && PIXI.ticker.shared.add(this._updateListener, this)
        },
        enumerable: !0,
        configurable: !0
    ...
    b = function(t) {
      ...
      return h(e, t), Object.defineProperty(e.prototype, "script", {
        get: function() {
        ...
        e.buffer = t.buffer, y.setParamValue(e.playbackRate, t.playbackRate.value), e.loop = t.loop;
    ...
    v = function() {
      ...
      return t.prototype.init = function(t) {
        this.parent = t, this._nodes = new b(this.context), this._source = this._nodes.bufferSource, this.source = t.options.source
      }, t.prototype.destroy = function() {
    ...
    P = function(t) {
      ...
      return h(e, t), e.prototype._unlock = function() {
    ...
    O = function(t) {
      function e(n, o, i, r, s, u, a, c, p, l) {
        void 0 === n && (n = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === r && (r = 0), void 0 === s && (s = 0), void 0 === u && (u = 0), void 0 === a && (a = 0), void 0 === c && (c = 0), void 0 === p && (p = 0), void 0 === l && (l = 0);
        var h = this;
        if (!_().useLegacy) {
          var f = [{
            f: e.F32,
            ...
            var e = _().context.audioContext.createBiquadFilter();
            return e.type = t.type, y.setParamValue(e.Q, 1), e.frequency.value = t.f, y.setParamValue(e.gain, t.gain), e
          });
          (h = t.call(this, f[0], f[f.length - 1]) || this).bands = f, h.bandsMap = {};
        ...
        h = t.call(this, null) || this
      }
      return h(e, t), e.prototype.setGain = function(t, e) {
        if (void 0 === e && (e = 0), !this.bandsMap[t]) throw new Error("No band found for frequency " + t);
        y.setParamValue(this.bandsMap[t].gain, e)
    ...
    j = function(t) {
      ...
      return h(e, t), Object.defineProperty(e.prototype, "amount", {
        get: function() {
          return this._amount
        },
        set: function(t) {
    ...
    w = function(t) {
      ...
      return h(e, t), Object.defineProperty(e.prototype, "pan", {
        get: function() {
          return this._pan
        },
        set: function(t) {
          this._pan = t, this._stereo ? y.setParamValue(this._stereo.pan, t) : this._panner.setPosition(t, 0, 1 - Math.abs(t))
        },
        enumerable: !0,
        configurable: !0
      }), e.prototype.destroy = function() {
    ...
    E = function(t) {
      function e(e, n, o) {
        ...
        var i = this;
        if (!_().useLegacy) return (i = t.call(this, null) || this)._seconds = i._clamp(e, 1, 50), i._decay = i._clamp(n, 0, 100), i._reverse = o, i._rebuild(), i;
        i = t.call(this, null) || this
      }
      return h(e, t), e.prototype._clamp = function(t, e, n) {
        ...
        for (var t, e = _().context.audioContext, n = e.sampleRate, o = n * this._seconds, i = e.createBuffer(2, o, n), r = i.getChannelData(0), s = i.getChannelData(1), u = 0; u < o; u++) t = this._reverse ? o - u : u, r[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay), s[u] = (2 * Math.random() - 1) * Math.pow(1 - t / o, this._decay);
    ...
    A = function(t) {
      function e() {
        if (!_().useLegacy) {
          var e = _().context.audioContext,
            n = e.createBiquadFilter(),
            o = e.createBiquadFilter(),
            i = e.createBiquadFilter(),
            r = e.createBiquadFilter();
          return n.type = "lowpass", y.setParamValue(n.frequency, 2e3), o.type = "lowpass", y.setParamValue(o.frequency, 2e3), i.type = "highpass", y.setParamValue(i.frequency, 500), r.type = "highpass", y.setParamValue(r.frequency, 500), n.connect(o), o.connect(i), i.connect(r), t.call(this, n, r) || this
        }
        t.call(this, null)
      }
      return h(e, t), e
    ...
    C = function(t) {
      function e(e) {
        var n = t.call(this) || this;
        return n.id = S++, n.init(e), n
      }
      return h(e, t), Object.defineProperty(e.prototype, "progress", {
        get: function() {
        ...
        var n = this,
          ...
          u = t.volume,
          a = t.muted;
        this._speed = r, this._volume = u, this._loop = !!s, this._muted = a, this.refresh(), this.loop && null !== i && (this.loop = !1), this._start = o, this._end = i || this._duration, this._start = Math.max(0, this._start - e.PADDING), this._end = Math.min(this._end + e.PADDING, this._duration), this._source.onloadedmetadata = function() {
    ...
    L = function(t) {
      ...
      return h(e, t), e.prototype.init = function(t) {
    ...
    M = function(t) {
      ...
      return h(e, t), e.prototype.refresh = function() {
        this.emit("refresh")
      }, e.prototype.refreshPaused = function() {
  ...
  var R, G, X, K, B = (R = {
      m4a: "mp4",
      oga: "ogg"
    }, G = document.createElement("audio"), X = {}, K = /^no$/, T.forEach(function(t) {
      var e = R[t] || t,
        n = G.canPlayType("audio/" + t).replace(K, ""),
        o = G.canPlayType("audio/" + e).replace(K, "");
      X[t] = !!n || !!o
    }), Object.freeze(X)),
    D = /\.(\{([^\}]+)\})(\?.*)?$/;
  ...
  var U = function() {
      ...
      return t.add = function() {
        ...
        t.data && T.indexOf(t.extension) > -1 ? t.sound = _().add(t.name, {
          loaded: e,
          preload: !0,
          url: t.url,
          source: t.data
    ...
    V = function(t) {
      function e(e, n) {
        ...
        return o.use(U.use), o.pre(U.pre), o
      }
      return h(e, t), e.addPixiMiddleware = function(e) {
    ...
    N = function() {
      ...
      return t.from = function(e) {
        var n = {};
        return "string" == typeof e ? n.url = e : e instanceof ArrayBuffer || e instanceof HTMLAudioElement ? n.source = e : n = e, (n = d({
          autoPlay: !1,
          singleInstance: !1,
          url: null,
          source: null,
          ...
          loaded: null,
          loop: !1
        }, n)).url && (n.url = q(n.url)), Object.freeze(n), new t(_().useLegacy ? new L : new v, n)
      }, Object.defineProperty(t.prototype, "context", {
        get: function() {
          return _().context
        },
    ...
    z = function() {
      ...
      return t.prototype.init = function() {
        ...
        if ("string" == typeof t) {
          if (e instanceof N) return this._sounds[t] = e, e;
        ...
        set: function(t) {
          U.legacy = t, this._useLegacy = t, this._context = !t && this.supported ? this._webAudioContext : this._htmlAudioContext
        },
        enumerable: !0,
        configurable: !0
  ...
  var Y = Object.freeze({
      ...
      render: function(t, e) {
        ...
        if (!(t.media instanceof v)) return o;
        var i = t.media,
          r = n.getContext("2d");
        r.fillStyle = e.fill;
        for (var s = i.buffer.getChannelData(0), u = Math.ceil(s.length / e.width), a = e.height / 2, c = 0; c < e.width; c++) {
          for (var p = 1, l = -1, h = 0; h < u; h++) {
            var f = s[c * u + h];
            f < p && (p = f), f > l && (l = f)
          }
          r.fillRect(c, (1 + p) * a, 1, Math.max(1, (l - p) * a))
        }
        return o
      },
      resolveUrl: q,
    ...
    $ = window,
    J = PIXI;
  if ("undefined" == typeof Promise && ($.Promise = n), void 0 !== PIXI.loaders) {
    var Q = parseInt(PIXI.VERSION.split(".")[0], 10);
    4 === Q ? (PIXI.loaders.Loader = V, U.add(), PIXI.loader.use(U.use), PIXI.loader.pre(U.pre)) : Q >= 5 && J.Loader.registerPlugin(U)
  }
  return void 0 === $.__pixiSound && delete $.__pixiSound, J.sound || (Object.defineProperty(J, "sound", {
    get: function() {
      return Z
    }
