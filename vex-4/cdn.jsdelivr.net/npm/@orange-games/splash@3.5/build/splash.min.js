    ...
    ! function(b) {
        var c = function(b) {
            function c(c, d) {
                ...
                }(window, document, "script", f + "blocked.invalid/analytics.js", "ga"), e
            }
...
! function(a) {
    ...
    var c = function() {
        ...
        }, b.SCHEDULE_TIME = 15e3, b.SDK_VERSION = "rest api v2", b.API_URL = ("https:" === document.location.protocol ? "https" : "http") + "://removed.invalid/v2/", b.instance = null, b
    }();
    a.GameAnalytics = c
}(GA || (GA = {}));
var GA;
