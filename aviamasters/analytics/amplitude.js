  ...
  var __webpack_modules__ = ({
    ...
    "../../node_modules/@rudderstack/analytics-js/dist/npm/modern/esm/index.mjs":
      ...
      ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        const SDK_CDN_BASE_URL = 'https://blocked.invalid';
        ...
        const remotesMap = {
          'rudderAnalyticsRemotePlugins': {
            url: () => Promise.resolve(window.RudderStackGlobals && window.RudderStackGlobals.app && window.RudderStackGlobals.app.pluginsCDNPath ? `${window.RudderStackGlobals.app.pluginsCDNPath}/rsa-plugins.js` : `https://blocked.invalid/v3/modern/plugins/rsa-plugins.js`),
            format: 'esm',
            from: 'vite'
          }
        };
